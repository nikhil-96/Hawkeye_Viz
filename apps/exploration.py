...
dfa['local_authority_district'] = dfa['local_authority_district'].map(
    district_names.set_index('local_authority_district')['label'])
...
layout = html.Div([
    ...
    ], style={ 'color': 'black', 'width': '100%', 'padding-left':'20%', 'padding-right':'20%'} #,'display': 'flex ', 'justify-content': 'center'}
    ...
    #layout :            {plot_bgcolor : '#111111',  paper_bgcolor : '#111111'}
    html.Div([
